...
while True:
    ...
    #Removes HWtype(type of link) from ARP cache
    ...
    def duplicateMAC():
        ...
        #Loop removes broadcast address
        ...
        try:
            ...
            if duplicate_mac in checkTable.keys():
                ...
                if choice != 'y':
                    if p.system()[0] == 'L': os.system('cls'); print(logo)
                    elif p.system()[0] == 'D': os.system('cls'); print(logo)
